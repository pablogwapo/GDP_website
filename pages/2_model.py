...
Mv = st.number_input('Mv: ', min_value=0, max_value=1, value = 0.01)
Hc = st.number_input('Hc: ', min_value=0, max_value=35, value = 0.01)
Skew = st.number_input('Skew: ', min_value=0, max_value=1.6, value = 0.01)
